import { withIsolationScope, getClient, debug, getActiveSpan, continueTrace, startSpan, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, SEMANTIC_ATTRIBUTE_SENTRY_SOURCE, handleCallbackErrors, SPAN_STATUS_ERROR, SPAN_STATUS_OK, captureException, getIsolationScope } from '@sentry/core';
...
async function withServerActionInstrumentationImplementation(serverActionName, options, callback) {
  return withIsolationScope(async (isolationScope) => {
    ...
    const continueTraceIfNoActiveSpan = getActiveSpan() ? (_opts, callback2) => callback2() : continueTrace;
