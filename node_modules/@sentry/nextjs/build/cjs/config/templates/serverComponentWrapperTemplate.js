...
if (typeof serverComponent === "function") {
  wrappedServerComponent = new Proxy(serverComponent, {
    apply: (originalFunction, thisArg, args) => {
      let sentryTraceHeader = void 0;
      let baggageHeader = void 0;
      let headers = void 0;
      try {
        const requestAsyncStore = requestAsyncStorage?.getStore();
        sentryTraceHeader = requestAsyncStore?.headers.get("sentry-trace") ?? void 0;
        baggageHeader = requestAsyncStore?.headers.get("baggage") ?? void 0;
...
const generateMetadata = routeModule.generateMetadata ? Sentry.wrapGenerationFunctionWithSentry(routeModule.generateMetadata, {
  componentRoute: "__ROUTE__",
  componentType: "__COMPONENT_TYPE__",
  generationFunctionIdentifier: "generateMetadata",
  requestAsyncStorage
}) : void 0;
const generateImageMetadata = routeModule.generateImageMetadata ? Sentry.wrapGenerationFunctionWithSentry(routeModule.generateImageMetadata, {
  componentRoute: "__ROUTE__",
  componentType: "__COMPONENT_TYPE__",
  generationFunctionIdentifier: "generateImageMetadata",
  requestAsyncStorage
}) : void 0;
const generateViewport = routeModule.generateViewport ? Sentry.wrapGenerationFunctionWithSentry(routeModule.generateViewport, {
  componentRoute: "__ROUTE__",
  componentType: "__COMPONENT_TYPE__",
