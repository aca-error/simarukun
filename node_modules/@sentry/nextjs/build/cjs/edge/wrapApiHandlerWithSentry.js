  ...
  return new Proxy(handler, {
    apply: async (wrappingTarget, thisArg, args) => {
      return core.withIsolationScope((isolationScope) => {
        ...
        let spanName;
        let op = "http.server";
        const urlObject = req instanceof Request ? core.parseStringToURLObject(req.url) : void 0;
        const urlAttributes = {
        ...
        if (activeSpan) {
          ...
          if (rootSpan) {
            ...
            rootSpan.setAttributes({
              ...
              [attributes.URL_FULL]: rootSpanAttributes[attributes.URL_FULL] ?? urlAttributes[attributes.URL_FULL],
              [attributes.URL_PATH]: rootSpanAttributes[attributes.URL_PATH] ?? urlAttributes[attributes.URL_PATH],
